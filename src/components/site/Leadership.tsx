...
export function Leadership() {
  ...
  return (
    <section id="about" className="bg-[#F8FAFC] text-slate-900 py-16 sm:py-24 border-b border-slate-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-200 pb-6">
          ...
          <div className="rounded-xs border border-slate-200 bg-white p-4 font-mono text-xs text-slate-800 shrink-0 shadow-xs">
            <p className="font-bold text-[#0E2A47]">Yard &amp; Workshop:</p>
            <p className="text-amber-800 font-semibold mt-0.5">D179 Sector 10, Noida, UP</p>
            <p className="text-slate-500 text-[0.6875rem] mt-0.5">Mon–Sat: 8:00 AM – 8:00 PM</p>
          </div>
        </div>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-12 items-start">
          ...
          <div className="lg:col-span-7 corp-card p-6 sm:p-7 flex flex-col justify-between bg-white">
            <div>
              {founder.photo && (
                <div className="aspect-[16/10] overflow-hidden rounded-xs bg-slate-100 border border-slate-200">
                  <img
                    src={founder.photo}
              ...
              <div className="mt-5">
                ...
                <div className="space-y-3 text-xs sm:text-sm leading-relaxed text-slate-600 font-sans">
                  <p>
            ...
            <div className="mt-6 pt-3 border-t border-slate-100 font-mono text-xs text-slate-500 flex items-center justify-between">
              <span>Daily Focus: Shop Welding, Crane Rigging &amp; Alignment</span>
              <span className="text-[#0E2A47] font-bold">Yard Floor Active</span>
            </div>
          </div>

          {/* 02. Next Gen: Abdul (5 cols — CAD Modeling & BOQ Estimation Focus) */}
          <div className="lg:col-span-5 corp-card p-6 sm:p-7 flex flex-col justify-between bg-white">
            <div>
              {nextGen.photo && (
                <div className="aspect-[4/3] overflow-hidden rounded-xs bg-slate-100 border border-slate-200">
                  <img
                    src={nextGen.photo}
            ...
            <div className="mt-6 pt-3 border-t border-slate-100 font-mono text-xs text-slate-500 flex items-center justify-between">
              ...
              <span className="text-[#0E2A47] font-bold">24-Hr Estimates</span>
            </div>
          </div>
        ...
        <div className="mt-12 rounded-xs border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
          <div className="grid gap-6 lg:grid-cols-12 items-center">
            <div className="lg:col-span-8 space-y-2">
              <span className="font-mono text-xs font-semibold uppercase text-amber-700">
